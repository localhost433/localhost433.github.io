...
> So:
>
> - Zip a dir. : "create + gzip + file" -> `tar czf archive.tar.gz path/`
> - Unzip: "extract + gzip + file" -> `tar xzf archive.tar.gz`
>  
> The order of flags doesn’t matter, which feels like a rare kindness in command-line (well in many other cases as well so maybe it’s not so rare).
>
