...
export { KnobBar, CompareCaption, CodeBlock, Mcq, McqFigure, mcq, renderCaption } from "@kit";
...
export class Plot {
  ...
  curve(fn, {
    ...
    g.strokeStyle = color || this.C.acc;
    g.lineWidth = width;
  ...
  polyline(pts, opts = {}) {
    const g = this.g;
    g.strokeStyle = opts.color || this.C.acc;
  ...
  vline(xv, {
    ...
    const g = this.g;
    g.strokeStyle = color || this.C.fg;
    g.lineWidth = width;
    if (dash) g.setLineDash(dash);
    g.beginPath();
    g.moveTo(this.x(xv), this.top);
    g.lineTo(this.x(xv), this.bottom);
    g.stroke();
    g.setLineDash([]);
    return this;
  }
...
export function useReveal(ref, steps, {
  ms = 900
} = {}) {
  ...
  React.useEffect(() => {
    if (steps <= 1 || reducedMotion()) {
      setStep(Math.max(0, steps - 1));
      return undefined;
    }
...
export function TableGrid({
  ...
  const head = (t, hxp, hyp, anchor, key) => texHead ? /*#__PURE__*/React.createElement(TeX, {
    key: key,
    x: hxp,
    y: hyp,
    anchor: anchor,
    ...
    fontSize: headSize,
    fill: C.muted,
    fontStyle: key === "corner" ? "italic" : undefined
  }, symRuns(t, headSize));
  return /*#__PURE__*/React.createElement("g", {
    style: {
      ...FADE,
  ...
  }, corner ? head(corner, x + hx / 2, y + hy / 2 + 4, "middle", "corner") : null, colHead ? colHead.map((h, c) => head(h, x + hx + c * cw + cw / 2, y + hy - 8, "middle", "ch" + c)) : null, rowHead ? rowHead.map((h, r) => head(h, x + hx - 8, y + hy + r * ch + ch / 2 + 4, "end", "rh" + r)) : null, cells.map((row, r) => row.map((cell, c) => {
    if (!cell) return null;
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      width: cw,
      height: ch,
      fill: cell.tone ? T.fill : C.bg,
      fillOpacity: cell.tone ? cell.alpha ?? T.fillOpacity : 1,
      stroke: rule ? C.border : "none",
      strokeWidth: "1"
    }), /*#__PURE__*/React.createElement("text", {
      x: cx + cw / 2,
      y: cy + ch / 2 + 4.5,
      ...
      fill: cell.fg || (cell.tone === "solid" ? "#fff" : C.fg)
    }, cell.t));
  })));
}
...
export class Scene3D {
  ...
  seg(a, b, {
    ...
    const g = this.g,
      p = this.project(a),
      q = this.project(b);
    g.strokeStyle = color || this.C.muted;
    g.lineWidth = width;
    if (dash) g.setLineDash(dash);
    g.beginPath();
    g.moveTo(p[0], p[1]);
  ...
  dot(p, {
    ...
    const g = this.g,
      q = this.project(p);
    g.fillStyle = color || this.C.acc;
    if (shape === "square") g.fillRect(q[0] - r, q[1] - r, 2 * r, 2 * r);else {
      g.beginPath();
      g.arc(q[0], q[1], r, 0, 2 * Math.PI);
      g.fill();
    }
    return this;
  }
  ...
  rightAngle(corner, u, v, {
    ...
    const a = unit(u),
      b = unit(v);
    const p1 = step(corner, a, size),
      p3 = step(corner, b, size);
...
export function TexLayer({
  labels,
  refs,
  C
}) {
  return /*#__PURE__*/React.createElement(React.Fragment, null, labels.map((l, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    ref: el => {
      refs.current[i] = el;
    },
...
export function Canvas3D({
  ...
  React.useEffect(() => {
    ...
    const frame = t => {
      if (!t0) t0 = t;
      if (sway) spun.current = sway.amp * Math.sin(2 * Math.PI * (t - t0) / (sway.seconds * 1000));else if (last) spun.current += spin * (t - last) / 1000;
      if (last) render();
      last = t;
  ...
  })), /*#__PURE__*/React.createElement(TexLayer, {
    labels: labels,
    refs: labelRefs,
    C: C
  }));
...
export function PlotFigure({
  ...
  React.useEffect(() => {
    const canvas = cv.current;
    if (!canvas) return;
    const plot = new plotClass(canvas, {
      width,
      height,
      colors: C,
      ...plotOpts
    ...
    labels.forEach((l, i) => placeLabel(labelRefs.current[i], plot.x(l.at[0]) * k, plot.y(l.at[1]) * k, l));
  });
  return /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
