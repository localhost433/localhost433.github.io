  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "10px", color: C.fg }}>
      ...
      <p style={{ ...labelStyle(C), margin: 0, lineHeight: 1.5 }}>
        ...
        the sum of the two plus the noise floor σ², and its minimum is where the two slopes
        cancel, which is not in general where the curves cross. (The variance axis is
