/* AUTO-GENERATED from union-bound-bins.jsx by `npm run build:artifacts`. Do not edit. */
...
class BinsPlot extends Plot {
  ...
  render({
    ...
    nus.forEach((v, i) => {
      ...
      g.lineWidth = 1;
      g.beginPath();
      g.moveTo(cx, this.y(MU));
      g.lineTo(cx, this.y(v));
      g.stroke();
      g.fillStyle = i === best ? C.acc : off ? C.neg : C.pos;
      g.beginPath();
      g.arc(cx, this.y(v), i === best ? 6.5 : 4.5, 0, 2 * Math.PI);
      g.fill();
      g.strokeStyle = C.bg;
      g.lineWidth = 1.5;
      g.stroke();
      if (i === best) {
        ...
        g.lineWidth = 2;
        g.beginPath();
        g.arc(cx, this.y(v), 11, 0, 2 * Math.PI);
        g.stroke();
      }
    });
    ...
    g.setLineDash([5, 4]);
    g.beginPath();
    g.moveTo(this.left, this.y(MU));
    g.lineTo(this.right, this.y(MU));
    g.stroke();
    g.setLineDash([]);
    this.label("μ = " + MU, this.left + 4, this.y(MU) - 6, {
      color: C.fg
    });
    ...
    this.label("ν", this.left - 6, this.top + 6, {
      align: "right"
    });
    return this;
  }
...
export default function App() {
  ...
  React.useEffect(() => {
    if (ref.current) new BinsPlot(ref.current, C, M).render({
      nus,
      eps
    });
  });
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "sr-only"
  }, "Many bins with the same true fraction: the best-looking sample fraction drifts from mu as the number of hypotheses grows, and the bound loosens by a factor of M."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: "10px",
    ...
    style: labelStyle(C)
  }, "hypotheses M"), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: "1",
    max: "40",
    step: "1",
    ...
    "aria-label": "Number of hypotheses M",
    style: {
      flex: "1 1 130px",
      minWidth: "110px",
      accentColor: C.acc
  ...
  }, "Resample")), /*#__PURE__*/React.createElement("canvas", {
    ref: ref,
    style: {
      width: "100%",
      maxWidth: W,
  ...
  }, "every bin has \u03BC = ", MU, ", yet the best-looking one reports \u03BD = ", best.toFixed(3), /*#__PURE__*/React.createElement("br", null), "single fixed h:  2e^(\u22122\u03B5\xB2N) = ", single.toFixed(3), /*#__PURE__*/React.createElement("br", null), "after choosing among M:  2Me^(\u22122\u03B5\xB2N) = ", many >= 1 ? "1 (says nothing)" : many.toFixed(3)), /*#__PURE__*/React.createElement("p", {
    style: {
      ...labelStyle(C),
      margin: 0,
      lineHeight: 1.5
    }
  }, "Every bin here has the same \u03BC, so every difference you see is sampling noise. Drag M up and watch the best-looking bin drift further below \u03BC: with more hypotheses to choose from, some bin looks good by luck alone, and picking it is what breaks the single-hypothesis guarantee. That is the difference between verification and learning. The bound pays the price as a factor of M, and at M = ", dead, " it reaches 1 and stops saying anything at all."));
}