/* AUTO-GENERATED from hoeffding-bin.jsx by `npm run build:artifacts`. Do not edit. */
...
class BinPlot extends HistogramPlot {
  ...
  render({
    ...
    this.band(Math.max(0, mu - eps), Math.min(1, mu + eps), {
      color: C.acc,
      alpha: 0.14
    });
    this.bins(nus, {
      bins: 40,
      inside: v => Math.abs(v - mu) <= eps
    });
    this.axes({
      y: false
    });
    ...
    this.label("ν = 1", this.right, this.bottom + 15, {
      align: "right"
    });
    return this;
  }
...
export default function App() {
  ...
  React.useEffect(() => {
    if (ref.current) new BinPlot(ref.current, C).render({
      nus,
      mu,
      eps
    });
  });
  const slider = props => /*#__PURE__*/React.createElement("input", _extends({
    type: "range"
  }, props, {
    style: {
      flex: "1 1 140px",
  ...
  const row = (label, node, read) => /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: "10px"
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "sr-only"
  }, "Bin experiment: the distribution of the sample fraction nu around the true fraction mu, with the Hoeffding bound."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: "6px"
    ...
    step: 0.01,
    value: mu,
    "aria-label": "True fraction mu",
    onChange: e => setMu(+e.target.value)
  }), "μ = " + mu.toFixed(2)), row("N", slider({
    min: 10,
    max: 1000,
    step: 10,
    value: N,
  ...
  }), "ε = " + eps.toFixed(2))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: "8px",
      flexWrap: "wrap"
  ...
  }, "Resample"), /*#__PURE__*/React.createElement("button", {
    type: "button",
    style: buttonStyle(C),
    onClick: () => {
      setEps(0.1);
  ...
  }, "\u03B5 = 0.10, N = 250"), /*#__PURE__*/React.createElement("button", {
    type: "button",
    style: buttonStyle(C),
    onClick: () => {
      setEps(0.05);
  ...
  }, "half \u03B5, 4\xD7 N")), /*#__PURE__*/React.createElement("canvas", {
    ref: ref,
    style: {
      width: "100%",
      maxWidth: W,
  ...
  }, "bound 2e^(\u22122\u03B5\xB2N) = ", bound.toFixed(4), "    observed miss rate = ", miss.toFixed(4)), /*#__PURE__*/React.createElement("p", {
    style: {
      ...labelStyle(C),
      margin: 0,
      lineHeight: 1.5
