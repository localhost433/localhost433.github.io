...
Define the standard normal $\xi=\dfrac{X-\mu}{\sigma} \sim \mathcal{N}(0,1)$, so $X=\sigma\xi+\mu$.

**Mean and variance**  
Using symmetry and integration by parts for $\xi \sim \mathcal{N}(0,1)$,
$$
...
**Example**  
If $X \sim \mathcal{N}(3,9)$, then $P(X>0)=\Phi(1)\approx 0.8413$ and
$$
