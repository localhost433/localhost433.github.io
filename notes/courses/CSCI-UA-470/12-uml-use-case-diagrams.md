...
> Where this sits in the course: UML is a **notation for design**, applied on top of the OOP ideas summarized in [note 16](note.html?course=CSCI-UA-470&note=16-oop-pillars-roadmap). A use case diagram captures requirements from the outside (*what, not how*) before those requirements are turned into the classes, inheritance, and polymorphism built throughout the earlier notes.
