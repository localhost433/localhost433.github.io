...
const asmMap = {
  ...
  19: [6, 7],     // Circle b = a;        -> two movs of the pointer, no new alloc
  14: [10, 11],   // delete radius;       -> load radius + call operator delete
  11: [15],       // radius = new int(*o.radius)  -> deep copy: call operator new
};

const asmLabel = "x86-64 · Intel (idealized)";

export default scene({ title: "Shallow vs deep copy: one heap allocation, or two?", code, steps, asm, asmMap, asmLabel });
