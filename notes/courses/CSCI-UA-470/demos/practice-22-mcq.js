/* AUTO-GENERATED from practice-22-mcq.jsx by `npm run build:artifacts` — do not edit. */
...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "`nextHandler` has the abstract parent's own type",
      correct: true
    }, {
    ...
    choices: [{
      text: "Commands first, Mementos second",
      correct: true
    }, {
    ...
    choices: [{
      text: "Read or change the fields inside a `Memento`",
      correct: true
    }, {
    ...
    choices: [{
      text: "A second dispatch, on the element's real type",
      correct: true
    }, {
    ...
    choices: [{
      text: "A job was taken out of the class that had it",
      correct: true
    }, {
