/* AUTO-GENERATED from pattern-factory.jsx by `npm run build:artifacts` — do not edit. */
...
const GOOD = patternTree({
  ...
  context: {
    title: "ShapeFactory",
    sections: [{
      rows: ["+ getShape(type) : Shape", "+ getRandomShape() : Shape"]
    }]
  },
  parent: {
    title: "Shape",
  ...
  children: [kid("Circle", "- radius"), kid("Rect", "- w, h"), kid("Triangle", "- base, h"), {
    ...kid("Cylinder", "- r, h"),
    dashed: true
  }, {
    ...kid("Square", "- side"),
