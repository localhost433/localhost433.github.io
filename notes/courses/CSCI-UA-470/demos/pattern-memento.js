...
const SAVE = ["Memento m = new Memento();", "m.title   = d.title;", "m.name    = d.name;", "m.content = d.content;", "mementos.add(m);"];
const UNDO = ["d.title   = mementos[-1].title;", "d.name    = mementos[-1].name;", "d.content = mementos[-1].content;", "mementos.remove(-1);"];
...
export default patternFigure({
  ...
  good: {
    ...
    node: /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement(DiagramCard, {
      x: docX,
      y: docY,
      w: DOC_W,
      title: "Document",
      ...
      y: CODE_Y,
      lines: SAVE,
      title: "CareTaker.save(d)"
    }), /*#__PURE__*/React.createElement(SvgCode, {
      x: undoX,
      y: CODE_Y,
      lines: UNDO,
      title: "CareTaker.undo()"
...
// ctrl+Z once more -> whatever was saved before that`,
  ...
  caption: {
    cols: [{
      ...
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "The ", /*#__PURE__*/React.createElement("code", {
        className: "mm-ic"
      }, "CareTaker"), " holds the stack and only that. It stores mementos in order and hands the last one back \u2014 it never interprets what is inside one.")
    }],
