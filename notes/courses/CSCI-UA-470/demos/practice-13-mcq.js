...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "A **synchronous** call — the caller blocks until the message completes",
      correct: true
    }, {
    ...
    choices: [{
      text: "That the object's method is **on the stack** — running its own code or waiting on a call it made",
      correct: true
    }, {
    ...
    choices: [{
      text: "A **dashed** line with an **open** arrowhead",
      correct: true
    }, {
    ...
    choices: [{
      text: "A **self-call**: a small loop off the object's own lifeline that nests a new activation",
      correct: true
    }, {
    ...
    choices: [{
      text: "Two **mutually-exclusive** branches: the top runs if the guard holds, the bottom (`[else]`) otherwise",
      correct: true
    }, {
    ...
    choices: [{
      text: "A specific **object** — `Mike`, an instance of class `Cashier` — the same underlined `name : Class` notation as an object diagram",
      correct: true
    }, {
