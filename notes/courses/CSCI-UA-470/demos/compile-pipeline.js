...
/* The C++ build pipeline (note 01), drawn as a VERTICAL flow so it stays legible:
   ...
   C++-vs-Java comparison stay consistent from one definition. */

export default function CompilePipeline() {
  return /*#__PURE__*/React.createElement(Pipeline, {
    maxWidth: 420,
    steps: cppBuildPipeline,
    ariaLabel: "The C++ build pipeline as a vertical flow: you write main.cpp (with mylib.h); the preprocessor and compiler turn it into assembly main.s; the assembler turns that into the unlinked object main.o; the linker combines main.o with precompiled libraries into the executable a.out; at runtime the OS loads it and the CPU executes it."
  });
}