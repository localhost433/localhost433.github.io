/* AUTO-GENERATED from pattern-taxonomy.jsx by `npm run build:artifacts` — do not edit. */
...
const CATS = [{
  title: "Creational",
  q: "how objects get MADE",
  rows: ["Singleton", "Factory", "Abstract Factory"]
}, {
  title: "Structural",
  q: "how objects are COMPOSED",
  rows: ["Adapter", "Composition", "Flyweight", "Proxy", "Facade", "Bridge", "Decorator"]
}, {
  title: "Behavioral",
  q: "how objects TALK",
  rows: ["Template Method", "Strategy", "State", "Command", "Mediator", "Observer", "Chain of Resp.", "Iterator"]
}];
const PAD = 14,
  CARD_W = 196,
  GAP = 22,
...
const H = Math.round(cardY + Math.max(...specs.map(s => diagramCardHeight(s.sections, {
  title: true
}))) + PAD);
const hubCx = PAD + rowW / 2,
  hubCy = PAD + TOP_H / 2;
export default function PatternTaxonomy() {
  ...
  }, "The catalog, in three questions"), /*#__PURE__*/React.createElement(DiagramSvg, {
    viewBox: `0 0 ${W} ${H}`,
    maxWidth: 760,
  ...
  }, "The three categories are not a filing convenience \u2014 they are three different questions. Ask ", /*#__PURE__*/React.createElement("strong", null, "how does this object get created"), " and you are in the creational column; ", /*#__PURE__*/React.createElement("strong", null, "how are these objects wired together"), " and you are in the structural one; ", /*#__PURE__*/React.createElement("strong", null, "who calls whom, and when"), " and you are in the behavioral one. Most \"which pattern is this?\" questions are answered by picking the column first."));
}