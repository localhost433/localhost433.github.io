  ...
  questions: [
    {
      ...
      choices: [
        { text: "Association — a plain line from `Person` to `Address`", correct: true },
    ...
    },
    {
      ...
      figure: { code: "class Person {\n    void mail(Address a) {\n        ...\n    }\n}", lang: "java" },
      choices: [
        { text: "Dependency — `Person` uses `Address` temporarily", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "A **dashed** line with a hollow triangle at `Drawable` — realization", correct: true },
