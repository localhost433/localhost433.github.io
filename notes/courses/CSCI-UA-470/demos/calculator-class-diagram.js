...
const mathSections = [{
  ...
  rows: ["+ do_addition(a : int, b : int) : int", "+ do_subtraction(a : int, b : int) : int", "+ do_multiply(a : int, b : int) : int"]
}];
const GUI = {
  x: 24,
  y: 30,
...
const MATH = {
  ...
  y: 96,
  w: 336,
  h: diagramCardHeight(mathSections)
};
export default function CalculatorClassDiagram() {
  ...
  }, "uses temporarily"), /*#__PURE__*/React.createElement("text", {
    x: 406,
    y: 346,
    textAnchor: "middle",
    style: {
