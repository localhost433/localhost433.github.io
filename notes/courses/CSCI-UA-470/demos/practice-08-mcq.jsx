  ...
  questions: [
    {
      ...
      choices: [
        { text: "C++ → native code per platform; Java → bytecode for a JVM", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Nothing — refs by value; local rebinding doesn't apply", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "`p1.age`=30, `p1.name`=\"Maya\" — same object; \"James\" garbage", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Java objects always use `new` on the heap; garbage collector reclaims them", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Methods virtual; `public` inheritance; no multiple class inheritance", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "One pure virtual ↔ `abstract` class; all pure virtual ↔ `interface`", correct: true },
