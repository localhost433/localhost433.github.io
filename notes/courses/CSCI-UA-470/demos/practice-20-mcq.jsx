  ...
  questions: [
    {
      ...
      choices: [
        { text: "Decorator — it stacks, which the others do not", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Facade vs. Proxy — one is new, one is invisible", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "The sharing is entirely inside the factory", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Outside the shared object — passed in per call", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "The composite holds a list of the abstraction it implements", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "The two dimensions are fixed and vary independently", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "A rule enforced at every call site is enforced at none", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "No — a facade adds an entrance, it does not seal the building", correct: true },
