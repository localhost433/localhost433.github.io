/* AUTO-GENERATED from pattern-decorator.jsx by `npm run build:artifacts` — do not edit. */
...
const GOOD = patternTree({
  ...
  children: [add("Flower", ["- color", "- number"]), add("Catering", ["- foodType", "- amount"]), add("Music", ["- type", "- length"])],
  cardW: 152,
  gap: 22,
...
b1.cost();     // Music asks Catering asks Flower asks Booking`,
  ...
  caption: {
    cols: [{
      tag: "wraps",
      kind: "cpp",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "A decorator ", /*#__PURE__*/React.createElement("strong", null, "holds"), " the thing it decorates and adds its own work around the call it forwards. Nested wrapping is what gives you every combination from three classes.")
    }, {
      tag: "vs. bridge",
      kind: "int",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "Both defeat a class explosion. Bridge splits ", /*#__PURE__*/React.createElement("em", null, "two fixed axes"), " apart; Decorator handles an ", /*#__PURE__*/React.createElement("em", null, "open-ended list of optional extras"), " that stack in any order and any number.")
    }],
