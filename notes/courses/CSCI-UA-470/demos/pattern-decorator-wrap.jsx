...
const code =
`Booking b1 = new Booking("01/17/26", 400);
...
const H = { region: "heap", header: 12 };
const booking = obj("Booking", [
  { name: "date", type: "String", size: 8 },
  { name: "cost", type: "double", size: 8 },
], H);
const flower = obj("Flower", [
  { name: "b", type: "Booking", size: 8, to: "bk" },
  { name: "number", type: "int", size: 4 },
], H);
const catering = obj("Catering", [
  { name: "b", type: "Booking", size: 8, to: "fl" },
  { name: "amount", type: "int", size: 4 },
], H);
const music = obj("Music", [
  { name: "b", type: "Booking", size: 8, to: "ca" },
  { name: "length", type: "int", size: 4 },
], H);

const BK = (hl) => booking("base", { date: '"01/17"', cost: "400" }, { id: "bk", hl });
const FL = (hl) => flower("+flowers", { number: "12" }, { id: "fl", hl });
const CA = (hl) => catering("+catering", { amount: "40" }, { id: "ca", hl });
