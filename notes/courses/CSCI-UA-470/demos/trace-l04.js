...
const steps = [{
  ...
  line: 2,
  cells: [c("c1", "red", 2.5), c("c2", "blue", 3.0, true)],
  caption: {
  ...
  line: 3,
  cells: [c("c1", "red", 2.5), c("c2", "blue", 3.0), c("c3", "\"\"", 0, true)],
  caption: {
  ...
  line: 5,
  cells: [c("c1", "red", 2.5), c("c2", "blue", 3.0), c("c3", "green", 4.5, true)],
  outputs: [{
    expr: "operator>>",
    result: "Enter color and radius:",
    note: "(you type: green 4.5)"
  }],
  caption: {
  ...
  line: 6,
  cells: [c("c1", "red", 2.5), c("c2", "blue", 3.0), c("c3", "green", 4.5)],
  outputs: [{
    expr: "operator>>",
    result: "Enter color and radius:",
    note: "(you type: green 4.5)"
    ...
    expr: "cout << c3",
    result: "I am a circle, my details are: green,4.5"
  }],
  caption: {
...
export default scene({
  title: "L04 — friend operator>> and operator<<",
  code,
  steps
});