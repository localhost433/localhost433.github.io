...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "\"person\" — call binds to pointer's static type",
      correct: true
    }, {
    ...
    choices: [{
      text: "Construct `Person` then `Student`; destroy `Student` then `Person`",
      correct: true
    }, {
    ...
    choices: [{
      text: "Same address — base is at offset 0, upcast is free",
      correct: true
    }, {
    ...
    choices: [{
      text: "`s.id` is 5; `s.Person::id` is 0 — both slots exist",
      correct: true
    }, {
    ...
    choices: [{
      text: "`using` shares one member; redefining creates a second slot",
      correct: true
    }, {
