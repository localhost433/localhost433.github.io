/* AUTO-GENERATED from practice-13-sequence-observer.jsx by `npm run build:artifacts` — do not edit. */
...
export default sequenceOrder({
  ...
  // handling setValue, firing notify
  {
    p: "model",
    from: 3,
    to: 4
  },
  // answering the view's getValue
  {
    p: "view",
    from: 2,
    to: 5
