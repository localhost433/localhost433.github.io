...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "Generalization — hollow-triangle arrow from each child to *Place Order*",
      correct: true
    }, {
    ...
    choices: [{
      text: "Include is mandatory; extend is optional and conditional",
      correct: true
    }, {
    ...
    choices: [{
      text: "Actors sit outside the boundary; box holds use-case ovals",
      correct: true
    }, {
    ...
    choices: [{
      text: "**What** the system does for its actors — behavior and requirements",
      correct: true
    }, {
