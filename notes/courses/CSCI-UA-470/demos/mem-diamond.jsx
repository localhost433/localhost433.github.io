...
const code =
`class person  { string name = "james"; };
...
const slots = (m) => [
  { name: "vbptr", kind: "vptr", size: 8, origin: "teacher", value: "-> +32", hl: m === "t-decl" || m === "t-res" },
  { name: "age",   type: "int", origin: "teacher", value: "25", hl: m === "t-decl" },
  { name: "vbptr", kind: "vptr", size: 8, origin: "student", value: "-> +16", hl: m === "s-decl" || m === "s-res" },
  { name: "age",   type: "int", origin: "student", value: "20", hl: m === "s-decl" },
  { name: "age",   type: "int", origin: "TA", value: "27", hl: m === "ta-decl" },
  { name: "name",  type: "string", size: 32, origin: "person", value: '"james"', hl: m === "person" || m === "t-res" || m === "s-res" },
];
const view = (m) => ({ title, slots: slots(m) });

const steps = [
  {
    line: [1, 2], layout: view("t-decl"),
    caption: {
...
export default scene({ title: "Virtual inheritance: finding the shared base by run-time offset", code, steps });
