...
const valSteps = [
  ...
  call(codeVal),
  {
    ...
    cells: [
      P1(), P2(),
      TMP("objA"), X("objB", true), Y("objA", true),
      A('"James"', "20"), B('"Maya"', "18"),
    ],
    caption: {
  ...
  },
  {
    ...
    outputs: [
      { expr: "p1.name", result: '"James"' },
      { expr: "p1.age",  result: "20" },
      { expr: "p2.name", result: '"Maya"' },
      { expr: "p2.age",  result: "18" },
    ],
  },
];
...
const refSteps = [
  ...
  call(codeRef),
  {
    ...
    cells: [
      P1(), P2(),
      X("objA", true), Y("objB", true),
      A('"James"', "20", true), B('"Maya"', "18", true),
    ],
    caption: {
  ...
  },
  {
    ...
    outputs: [
      { expr: "p1.name", result: '"Maya"' },
      { expr: "p1.age",  result: "18" },
      { expr: "p2.name", result: '"James"' },
      { expr: "p2.age",  result: "20" },
    ],
  },
];
  ...
  knobs: [
    {
      ...
      label: "Swap by",
      options: [
        { value: "val", label: "reassigning handles" },
        { value: "ref", label: "mutating fields" },
      ],
      default: "val",
    },
  ],
