...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "True — `a = b` assigns 3, a non-zero value",
      correct: true
    }, {
    ...
    choices: [{
      text: "Always true — parses as `(3 < a) < 8`, i.e. `1 < 8`",
      correct: true
    }, {
    ...
    choices: [{
      text: "Other functions: undefined behavior. `main` is special: returns 0",
      correct: true
    }, {
    ...
    choices: [{
      text: "No — `long` differs between platforms; use `long long` or check `sizeof`",
      correct: true
    }, {
    ...
    choices: [{
      text: "Both wrong: (1) fails to copy; (2) compares addresses, not contents",
      correct: true
    }, {
