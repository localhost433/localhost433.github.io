...
export default mcq({
  questions: [
    ...
    },
    {
      ...
      choices: [
        { text: "**Define** declares a reference; **create** instantiates with `new`", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Only the concrete class", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Multiple implementation and modern `default`/`static`/`private` methods", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Abstract class ↔ ≥ 1 pure virtual; interface ↔ all pure virtual", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Multiple and multi-level+multiple; uses interface implementation", correct: true },
