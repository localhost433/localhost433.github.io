  ...
  questions: [
    {
      ...
      choices: [
        { text: "`<<include>>` — the shared step always runs, so factor it out", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "`<<extend>>`, arrow from *Write a review* → *View product details* (extension → base)", correct: true },
