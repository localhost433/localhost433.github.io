/* AUTO-GENERATED from practice-22-dispatch.jsx by `npm run build:artifacts` — do not edit. */
...
v.visit(s);`
    ...
    choices: [{
      text: "It does not compile — no overload accepts a `Shape`",
      correct: true
    }, {
...
class Rectangle extends Shape { }`
    ...
    choices: [{
      text: "`this` is statically a `Shape` — no overload fits",
      correct: true
    }, {
    ...
    choices: [{
      text: "Two — one on the shape, one on the visitor",
      correct: true
    }, {
    ...
    choices: [{
      text: "The `Visitor` interface and all its implementers",
      correct: true
    }, {
