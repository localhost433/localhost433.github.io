...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "The two are the same interaction; generalize so the difference becomes a parameter",
      correct: true
    }, {
    ...
    choices: [{
      text: "It earned its place by exchanging messages — the interaction discovers objects the use case never named",
      correct: true
    }, {
