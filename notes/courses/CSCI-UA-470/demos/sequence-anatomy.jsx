...
export default sequenceDiagram({
  ...
  messages: [
    { from: "cust", to: "cashier", label: "place_order(details)", kind: "sync" },
    { from: "cashier", to: "cust", label: "price", kind: "return" },
  ],
  // the cashier's method is on the stack for the whole call
  activations: [{ p: "cashier", from: 0, to: 1 }],
  ...
  annotations: [
    { t: "participant", x: 166, y: -14, to: { x: 166, y: 0 } },
    { t: "lifeline", x: 248, y: 70, anchor: "start", to: { x: 166, y: 88 } },
    { t: "activation", x: 248, y: 118, anchor: "start", to: { x: 171, y: 118 } },
    { t: "message", x: -8, y: 98, anchor: "end", to: { x: 6, y: 98 } },
    { t: "return", x: -8, y: 144, anchor: "end", to: { x: 6, y: 144 } },
  ],
});
