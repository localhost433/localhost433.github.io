...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "SRP — fleet accounting is a second responsibility, a second reason for `Car` to change",
      correct: true
    }, {
    ...
    choices: [{
      text: "No — it means one **responsibility** (one reason to change); the class may still be rich",
      correct: true
    }, {
    ...
    choices: [{
      text: "Make `Shape` abstract with an abstract `getArea()`; each subclass overrides it — new shapes extend, nothing is edited",
      correct: true
    }, {
    ...
    choices: [{
      text: "Violation — `Bird b = new Ostrich(); b.fly();` breaks the parent's promise, so the hierarchy is wrong",
      correct: true
    }, {
    ...
    choices: [{
      text: "ISP — split into `Movable` and `Jumpable`; `Vehicle` implements only `Movable`",
      correct: true
    }, {
    ...
    choices: [{
      text: "Both should depend on a `MessageSender` abstraction: the service calls the interface, the senders implement it",
      correct: true
    }, {
