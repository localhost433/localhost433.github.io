...
export default sequenceDiagram({
  participants: [{
    ...
    id: "check",
    label: "theCheck : Check"
  }, {
    id: "acct",
    label: "account : CheckingAccount"
  }],
  messages: [{
    from: "bank",
    to: "check",
  ...
  // 3
  {
    from: "bank",
    to: "acct",
    label: "addDebitTransaction(amount)",
    kind: "sync"
  },
  // 4
  {
    from: "bank",
    to: "acct",
    label: "storePhotoOfCheck(theCheck)",
    kind: "sync"
  },
  // 5
  {
  ...
  // 6
  {
    from: "bank",
    to: "acct",
    label: "noteReturnedCheck(theCheck)",
    kind: "sync"
  } // 7
  ],
  activations: [{
