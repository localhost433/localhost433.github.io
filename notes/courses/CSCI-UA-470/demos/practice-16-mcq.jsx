  ...
  questions: [
    {
      ...
      choices: [
        { text: "SRP — fleet accounting is a separate responsibility", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "No — one **responsibility** (one reason to change); class can be rich", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Make `Shape` abstract with abstract `getArea()` in each subclass", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Violation — `Bird b = new Ostrich(); b.fly();` breaks the contract", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "ISP — split into `Movable` and `Jumpable` interfaces", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Introduce `MessageSender` abstraction; both depend on it", correct: true },
