...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "Design — UML, SOLID, and the pattern catalog",
      correct: true
    }, {
    ...
    choices: [{
      text: "A document in a notation both sides can read",
      correct: true
    }, {
    ...
    choices: [{
      text: "Coupling and cohesion set the cost of change either way",
      correct: true
    }, {
    ...
    choices: [{
      text: "Regeneration is non-deterministic and can break callers",
      correct: true
    }, {
    ...
    choices: [{
      text: "From writing code to reading and reviewing it",
      correct: true
    }, {
    ...
    choices: [{
      text: "Where the boundaries between units should fall",
      correct: true
    }, {
