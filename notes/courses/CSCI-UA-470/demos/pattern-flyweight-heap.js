...
const code = `v = VehicleFactory.getVehicle(car,  red);    // miss
...
const CAR = hl => carObj("Car #1", {
  color: '"red"'
}, {
  id: "car1",
  hl
});
const BIKE = hl => bikeObj("Bike #1", {
  color: '"blue"'
}, {
  id: "bike1",
  hl
});
const V = (target, hl) => stack("v", "vehicle", "ref", {
  id: "v",
  to: target,
  hl
});
