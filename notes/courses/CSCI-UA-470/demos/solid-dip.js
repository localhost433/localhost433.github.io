...
export default function SolidDip() {
  ...
  }, "BEFORE \u2014 policy depends on a detail"), /*#__PURE__*/React.createElement(UmlLink, {
    from: {
      x: B_SVC.right,
      y: B_ARROW_Y
    },
  ...
  }, "AFTER \u2014 both sides depend on the abstraction"), /*#__PURE__*/React.createElement(UmlLink, {
    from: {
      x: G_SVC.right,
      y: G_SVC.y + 30
    },
