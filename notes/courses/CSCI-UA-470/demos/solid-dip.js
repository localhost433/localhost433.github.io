...
const BSVC = {
  x: 20,
  y: 30,
  h: diagramCardHeight(svc.sections)
};
const BEML = {
  x: 20,
  y: 176
...
const GIFC = {
  x: 690,
  y: 30,
  h: diagramCardHeight(ifc.sections)
};
const GROW = 196;
export default function SolidDip() {
  ...
  }, "policy names a concrete class \u2014"), /*#__PURE__*/React.createElement("text", {
    x: 312,
    y: 184,
    textAnchor: "middle",
    style: {
  ...
  }, "switching to SMS edits the service"), /*#__PURE__*/React.createElement(UmlLink, {
    from: {
      x: GSVC.x + W2,
      y: 70
    },
