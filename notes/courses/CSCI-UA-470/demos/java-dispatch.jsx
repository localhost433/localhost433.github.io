...
const asmMap = {
  9:  [5, 6, 7, 8],    // Shape s = new Circle();  -> new, dup, invokespecial, astore_1
  10: [9, 10],         // s.draw();                -> aload_1, invokevirtual #10
...
const SHAPE_DRAW  = (hl) => text("Shape.draw",  "method", "(default)",  { id: "shape_draw", hl });
const SHAPE_AREA  = (hl) => text("Shape.area",  "method", "return 0",   { id: "shape_area", hl });
const CIRCLE_DRAW = (hl) => text("Circle.draw", "method", "g.oval(...)", { id: "circle_draw", hl });
...
const SHAPE_MT = (hl) => glob("Shape methods", "method table", "", { id: "mt_shape", hl, fields: [
  { name: "draw", size: 8, to: "shape_draw", value: "&Shape.draw" },
  { name: "area", size: 8, to: "shape_area", value: "&Shape.area" },
]});
const CIRCLE_MT = (hl) => glob("Circle methods", "method table", "", { id: "mt_circle", hl, fields: [
  { name: "draw", size: 8, to: "circle_draw", value: "&Circle.draw" },
  { name: "area", size: 8, to: "shape_area", value: "&Shape.area" },
]});
...
export default scene({
  ...
  code, steps, lang: "java", asm, asmMap, asmLabel, asmLang: "bytecode",
});
