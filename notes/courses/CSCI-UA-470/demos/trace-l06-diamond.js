...
const PP = part("(person)", "virtual base", [{
  name: "name",
  type: "string",
  size: 32,
  value: '"james"'
}], "pp");
const TP = part("(teacher)", "part", [{
  name: "age",
  type: "int",
  value: "25"
}], "tp");
...
const AP = part("(TA)", "part", [{
  name: "age",
  type: "int",
  value: "27"
}], "ap");
const out = ladder(["Person constructor called.", "Teacher constructor called.", "Student constructor called.", "TA constructor called.", "==============================", "TA destructor called.", "Student destructor called.", "Teacher destructor called.", "Person destructor called."]);
const steps = [{
  line: [3, 4],
  cells: [PP(true)],
  outputs: out(1),
  ...
  line: 17,
  cells: [PP(), TP(), SP(true, true), AP(false, true)],
  outputs: out(7),
  caption: {
  ...
  line: 11,
  cells: [PP(), TP(true, true), SP(false, true), AP(false, true)],
  outputs: out(8),
  caption: {
  ...
  line: 5,
  cells: [PP(true, true), TP(false, true), SP(false, true), AP(false, true)],
  outputs: out(9),
  caption: {
...
export default scene({
  title: "L06 — virtual-inheritance diamond: order of construction & destruction",
  code,
  steps
});