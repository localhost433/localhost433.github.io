...
const base = [
  glob("students::age", "int", 20, { id: "sage" }),
  glob("teachers::age", "int", 30, { id: "tage" }),
  text("students::add()", "int()", "return 100", { id: "sadd" }),
  text("teachers::add()", "int()", "return 200", { id: "tadd" }),
];
const hl = spotlight(base);

const O = [
  { expr: "cout << age", result: "20" },
  { expr: "cout << teachers::age", result: "30" },
  { expr: "cout << add()", result: "100" },
  { expr: "cout << MESSAGE", result: "Hello, World!" },
  { expr: "cout << ABS(-5)", result: "5" },
];
