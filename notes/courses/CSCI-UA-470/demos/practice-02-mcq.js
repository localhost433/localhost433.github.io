...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "7 — by value unchanged; pointer and reference each add one",
      correct: true
    }, {
    ...
    choices: [{
      text: "`&r` equals `&x`; `&p` is different (pointer has its own storage)",
      correct: true
    }, {
    ...
    choices: [{
      text: "Pointers hold addresses, not integers; use `&x` instead",
      correct: true
    }, {
    ...
    choices: [{
      text: "You do, explicitly with `delete` or `delete[]`",
      correct: true
    }, {
    ...
    choices: [{
      text: "Frees the memory but leaves `p` unchanged — now a dangling pointer",
      correct: true
    }, {
    ...
    choices: [{
      text: "Calling `delete` twice on the same memory — undefined behavior",
      correct: true
    }, {
