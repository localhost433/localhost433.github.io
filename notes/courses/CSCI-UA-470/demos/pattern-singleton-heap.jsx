...
const FIELD = (linked, hl) => glob("instance", "Singleton", linked ? "ref" : "null",
  { id: "field", to: linked ? "sing" : undefined, hl });

// the one object, on the heap, with a Java object header.
const singleton = obj("Singleton", [{ name: "count", type: "int", size: 4 }],
  { region: "heap", header: 12 });
const OBJ = (hl, count) => singleton("the object", { count }, { id: "sing", hl });

const REF = (name, hl) => stack(name, "Singleton", "ref", { id: name, to: "sing", hl });
