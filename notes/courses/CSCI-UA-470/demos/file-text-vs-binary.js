...
function recordRow(x, y, w, row, mode) {
  ...
  }, op), /*#__PURE__*/React.createElement("text", {
    x: x + 86,
    y: y + 41,
    textAnchor: "start",
    dominantBaseline: "central",
  ...
  }, "bytes"), byteRun(x + 120, y + 29, bytes, sub));
}
export default function FileTextVsBinary() {
  ...
  }, "Text file vs binary file - same values, different decoding rules"), /*#__PURE__*/React.createElement(DiagramSvg, {
    viewBox: "0 0 780 506",
    maxWidth: 780,
  ...
  }, "one logical sequence of Java values"), values.map((v, i) => valueChip(165 + i * 118, 58, v.value, v.type)), panel(TX, 124, PW, 308, "Text file", "characters → encoded bytes", "heap"), panel(BX, 124, PW, 308, "Binary file", "format-specific byte records", "global"), rows.map((row, i) => recordRow(RX_T, RY + i * 60, RW, row, "text")), rows.map((row, i) => recordRow(RX_B, RY + i * 60, RW, row, "binary")), /*#__PURE__*/React.createElement("line", {
    x1: "26",
    y1: "450",
    x2: "754",
    y2: "450",
  ...
  }, "Text bytes assume an ASCII/UTF-8-compatible encoding of these characters."), /*#__PURE__*/React.createElement("text", {
    x: 32,
    y: 484,
    textAnchor: "start",
    style: {
  ...
  }, "The binary side is DataOutputStream primitive output; ObjectOutputStream uses a richer object-stream format.")), /*#__PURE__*/React.createElement(CompareCaption, {
    cols: [{
      tag: "text",
      kind: "java",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "A text writer converts the value to characters first. The bytes are intended to be decoded as text.")
    }, {
      tag: "binary",
      kind: "cpp",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "A binary writer stores bytes according to a particular file or stream format. The reader must know that format.")
    }],
