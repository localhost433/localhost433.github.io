/* AUTO-GENERATED from practice-11-mcq.jsx by `npm run build:artifacts` — do not edit. */
...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "The heap and the method area",
      correct: true
    }, {
    ...
    figure: {
      code: "iconst_1   // push 1\niconst_2   // push 2\niadd       // pop 2, pop 1, push sum",
      lang: "java"
    },
    choices: [{
      text: "`3`",
