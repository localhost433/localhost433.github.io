  ...
  questions: [
    {
      ...
      choices: [
        { text: "The method receives the object **implicitly as `this`**; the free function takes it as an **explicit parameter**", correct: true },
    ...
    },
    {
      ...
      figure: { code: "class Person {\n    string name;\n};\nPerson p1;\np1.name = \"James\";   // ?", lang: "cpp" },
      choices: [
        { text: "`private` by default, so `p1.name` is a **compile error**", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "A class is a blueprint that occupies **no data memory**; each object is a separate instance with **its own** data", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "It has the **same name as the class**, has **no return type**, and can be **overloaded**", correct: true },
    ...
    },
    {
      ...
      figure: { code: "void set_radius(double r) {\n    if (r < 0) { radius = 0; }\n    radius = r;\n}", lang: "cpp" },
      choices: [
        { text: "The guard is useless — `radius = r;` runs **unconditionally** and overwrites it, storing the negative value", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Automatically when the object is destroyed (goes out of scope, or is `delete`d); named `~ClassName()`, no parameters, no return type", correct: true },
