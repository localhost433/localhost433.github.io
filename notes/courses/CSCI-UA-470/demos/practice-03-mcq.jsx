  ...
  questions: [
    {
      ...
      choices: [
        { text: "Method: implicitly `this`; function: explicit parameter", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "`private` by default — `p1.name` is a compile error", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Class is a blueprint (no data); each object has its own data", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Same name as class, no return type, can be overloaded", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Guard is useless — `radius = r;` overwrites it", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Automatically on destruction; named `~ClassName()`; no params", correct: true },
