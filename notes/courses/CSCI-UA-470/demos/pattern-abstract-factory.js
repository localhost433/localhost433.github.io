...
const kids = (names, extra) => [...names.map(kid), {
  ...kid(extra),
  dashed: true
}];
const FAMILIES = [{
  ...
  get: "getShape(type)",
  rand: "getRandomShape()",
  names: ["Circle", "Rect", "Triangle"],
  extra: "Cylinder"
}, {
  factory: "VehicleFactory",
  type: "Vehicle",
  get: "getVehicle(type)",
  rand: "getRandomVehicle()",
  names: ["Car", "Flight", "Bike"],
  extra: "Truck"
}, {
...
const rows = FAMILIES.map(f => patternTree({
  ...
  context: {
    title: f.factory,
    sections: [{
      rows: [`+ ${f.get} : ${f.type}`, `+ ${f.rand} : ${f.type}`]
    }]
  },
  parent: {
    title: f.type,
...
export default patternFigure({
  ...
  good: {
    ...
    viewBox: `0 0 ${W} ${H}`,
    maxWidth: 760,
    node: /*#__PURE__*/React.createElement("g", null, placed),
...
a = AnimalFactory.getRandomAnimal();`,
  ...
  caption: {
    cols: [{
      tag: "factory",
      kind: "cpp",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "Answers ", /*#__PURE__*/React.createElement("em", null, "which concrete class"), " inside ", /*#__PURE__*/React.createElement("strong", null, "one"), " hierarchy. There is one product type, and the client holds it.")
    }, {
      tag: "abstract f.",
      kind: "int",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "Answers the same question ", /*#__PURE__*/React.createElement("strong", null, "across several related hierarchies"), ". Add a family and you add a factory \u2014 you do not touch the existing ones.")
    }],
