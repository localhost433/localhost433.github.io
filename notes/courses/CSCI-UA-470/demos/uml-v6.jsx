...
export default function UmlV6() {
  return (
    <DiagramSvg viewBox={`0 0 ${W} ${H}`} maxWidth={720}
      ...
      <text x={14} y={30}
        style={{ fill: "var(--mm-muted)", fontSize: 10, fontStyle: "italic" }}>solid = extends · dashed = implements</text>

      <DiagramCard x={drawCx - IW / 2} y={IY} w={IW} title={drawable.title}
        sections={drawable.sections} abstract neutral />
      <DiagramCard x={movCx - IW / 2} y={IY} w={IW} title={movable.title}
