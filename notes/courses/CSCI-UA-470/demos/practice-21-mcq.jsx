...
/* note 21 practice — the graded pass over the six patterns that vary behaviour by
   ...
   becomes a field of an abstract type plus one polymorphic call.

   Chain and Iterator questions live in practice-22-mcq with their sections. */
  ...
  questions: [
    {
      ...
      choices: [
        { text: "Intent — who chooses, and what the choice is for", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "The alternatives replace one another over time", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Command — the request was made into a storable object", correct: true },
        { text: "Strategy — the list holds interchangeable algorithms" },
        { text: "State — the list records the sequence of states" },
        { text: "Template Method — the list holds the fixed steps" },
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Mediator relays between peers; Observer announces outward", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Template Method — it varies behaviour by inheritance", correct: true },
        { text: "Observer — it is the only one with an opt-in registry" },
    ...
    {
      stem: "Three of these six begin from a rejected design with a `String` field and an if-chain over it. What is the general move that fixes all three?",
      choices: [
        { text: "Replace the field with an abstract type and delegate", correct: true },
