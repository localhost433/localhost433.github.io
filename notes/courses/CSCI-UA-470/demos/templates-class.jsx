...
const mkBoxInt    = obj("Box<int>",    [{ name: "value", type: "int",    size: 4  }], { region: "stack" });
const mkBoxDouble = obj("Box<double>", [{ name: "value", type: "double", size: 8  }], { region: "stack" });
const mkBoxString = obj("Box<string>", [{ name: "value", type: "string", size: 32 }], { region: "stack" });

const BI = (hl) => mkBoxInt("bi",    [], { id: "bi", hl });
const BD = (hl) => mkBoxDouble("bd", [], { id: "bd", hl });
const BS = (hl) => mkBoxString("bs", [], { id: "bs", hl });
