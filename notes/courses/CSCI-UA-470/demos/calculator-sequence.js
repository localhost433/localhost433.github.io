...
export default sequenceDiagram({
  ...
  caption: {
    text: "Sub and Multiply are this exact diagram with do_subtraction / do_multiply swapped in",
    color: "--mm-muted"
  }
});