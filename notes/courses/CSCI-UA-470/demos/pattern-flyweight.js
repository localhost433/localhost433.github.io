...
while (true) {
  ...
  caption: {
    cols: [{
      tag: "shared",
      kind: "cpp",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "Two callers asking for a ", /*#__PURE__*/React.createElement("em", null, "red car"), " get the ", /*#__PURE__*/React.createElement("strong", null, "same object"), ". That is safe only because the shared state is the state that defines it \u2014 type and colour.")
    }, {
      tag: "cost",
      kind: "int",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "The factory grows a field and a lookup; the program loses a thousand allocations and the garbage they become. The trade is memory-for-lookup, and it only pays when duplicates are common.")
    }],
