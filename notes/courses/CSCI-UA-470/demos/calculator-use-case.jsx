...
export default useCaseDiagram({
  system: "Calculator",
  actors: [{ id: "user", label: "User", x: 130, y: 150 }],
  cases: [
    { id: "add", label: "Add numbers", x: 400, y: 60 },
    { id: "sub", label: "Sub numbers", x: 400, y: 150 },
    { id: "mul", label: "Multiply numbers", x: 400, y: 240 },
  ],
  associations: [{ actor: "user", cases: ["add", "sub", "mul"] }],
  caption: { text: "three goals that differ only in the operation — remember the converter", color: "--mm-muted" },
});
