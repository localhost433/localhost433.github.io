...
const A = (hl) => circle("a", ['""', "?"], { hl });
const B = (hl) => circle("b", ['""', "?"], { hl });
...
const asmMap = {
  19: [7, 8, 19, 20, 21, 22],   // Circle a, b;  -> Circle::Circle bumps counter, called twice in main
  9:  [10, 11, 12],             // static void resetCounter()  -> its body (writes counter, no this)
  14: [5, 6, 13, 14, 15, 16],   // static int n = 0;  -> data symbol + nextId: load/inc/store
