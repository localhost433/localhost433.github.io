  ...
  questions: [
    {
      ...
      choices: [
        { text: "\"student\" — `virtual` dispatches to actual type", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "vptr → vtable → function; 8-byte per object", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Pure virtual method; can use pointers/references, not objects", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "No — `Student` abstract; must implement pure virtuals", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Two `Person` copies → `name` ambiguous", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "`Teacher`/`Student`: `virtual public Person`", correct: true },
