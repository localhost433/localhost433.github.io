...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "Overriding (same signature in a subclass)",
      correct: true
    }, {
    ...
    choices: [{
      text: "`Circle` must explicitly `implements Drawable`",
      correct: true
    }, {
    ...
    choices: [{
      text: "Tells the compiler to check if the method really overrides a supertype method",
      correct: true
    }, {
