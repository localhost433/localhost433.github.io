  ...
  questions: [
    {
      ...
      choices: [
        { text: "It **stamps out** a separate concrete function per type — `max<int>` and `max<double>` become two independent functions, at compile time", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "None — instantiation and type-checking happen at compile time; the generated code is as if you wrote it by hand", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "(2) — one type parameter `T` forces **both** arguments to the same type, and `T` cannot be both `Person` and `Circle`", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "They are **separate, unrelated** concrete classes with their own layouts (`Box<int>` 4 bytes, `Box<double>` 8) — neither is assignable to the other", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "None here — `typename` and `class` are interchangeable when introducing a template type parameter", correct: true },
