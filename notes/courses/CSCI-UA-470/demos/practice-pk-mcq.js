...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "A dashed dependency from MainGUI to FileManager",
      correct: true
    }, {
    ...
    choices: [{
      text: "The line style — dashed for implements, solid for extends",
      correct: true
    }, {
    ...
    choices: [{
      text: "View passwords — the constructor ends by loading the list",
      correct: true
    }, {
    ...
    choices: [{
      text: "In lstPasswords, the field behind the aggregation diamond",
      correct: true
    }, {
