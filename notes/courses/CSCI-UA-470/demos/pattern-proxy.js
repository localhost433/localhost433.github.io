...
const ph = diagramCardHeight(PROXY.sections, {
  title: true
});
const rh = diagramCardHeight(REAL.sections, {
  title: true
});
...
// distinguishes a query that reads from one that destroys`,
  ...
  good: {
    ...
    node: /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("text", {
    ...
    }, "PROXY"), /*#__PURE__*/React.createElement("text", {
      x: realX + CARD_W / 2,
      y: PAD + 8,
      textAnchor: "middle",
      style: {
    ...
    }, "REAL SUBJECT"), /*#__PURE__*/React.createElement(DiagramCard, {
      x: PAD,
      y: axis - ph / 2,
      w: CARD_W,
      title: PROXY.title,
      sections: PROXY.sections,
      sub: 1
      ...
      x: PAD,
      y: axis + Math.max(ph, rh) / 2 + 22,
      lines: BODY,
      title: "DBCNN.runQuery(q)"
    }))
  },
  client: {
    lang: "java",
...
dbc.runQuery(q);        //  insert  ✓    select  ✓    delete  ✗`,
  ...
  caption: {
    cols: [{
      ...
      tag: "new rule",
      kind: "int",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "Between the call and the real object it inserts a decision. Here it is a permission check; the same slot holds lazy loading, caching, logging, or a remote call.")
    }],
