...
export default useCaseBuild({
  ...
  source: {
    tokens: [
      "A", { w: "Member", role: "actor" }, "can", { w: "borrow", role: "case", id: "borrow" },
      "and", { w: "search for", role: "case", id: "search" }, "books,", "while", "a",
      { w: "Librarian", role: "actor" }, "can", { w: "add", role: "case", id: "add" },
      "new", "books", "to", "the", "shelf.",
    ],
  },
  elements: [
    { id: "member", label: "Member", role: "actor",
      whyZone: "The Member is a person the system serves — an actor OUTSIDE the boundary." },
    { id: "librarian", label: "Librarian", role: "actor",
      whyZone: "The Librarian is also an actor — outside the boundary, not a use case inside it." },
    { id: "borrow", label: "Borrow Book", role: "case",
      whyZone: "Borrowing is a goal the system provides — a use-case oval INSIDE the boundary." },
    { id: "search", label: "Search for book", role: "case",
      whyZone: "Searching is a use case the system offers — inside the boundary." },
    { id: "add", label: "Add book", role: "case",
      whyZone: "Adding a book is a use case — inside the boundary." },
  ],
  associations: [
    { actor: "member", cases: ["borrow", "search"] },
    { actor: "librarian", cases: ["add"] },
  ],
  relations: [
    { from: "borrow", to: "search", kind: "extend",
