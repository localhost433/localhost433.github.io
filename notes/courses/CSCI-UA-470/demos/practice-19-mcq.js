...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "So no caller can build a second object with `new`",
      correct: true
    }, {
    ...
    choices: [{
      text: "Compile error — the constructor is not visible there",
      correct: true
    }, {
    ...
    choices: [{
      text: "The stored reference is returned; no object is created",
      correct: true
    }, {
    ...
    choices: [{
      text: "There is no instance yet to call it on",
      correct: true
    }, {
    ...
    choices: [{
      text: "Factory — one product hierarchy behind one door",
      correct: true
    }, {
    ...
    choices: [{
      text: "Open–Closed — a new product adds a class, edits none",
      correct: true
    }, {
    ...
    choices: [{
      text: "Into the factory — one copy instead of one per client",
      correct: true
    }, {
