  ...
  questions: [
    {
      ...
      choices: [
        { text: "\"person\" — without `virtual`, the call binds to the pointer's **static type** `Person*`", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Construct `Person` then `Student`; destroy `Student` then `Person` (destruction is the reverse of construction)", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Same address — the base subobject sits at offset 0, so upcasting moves nothing; it just narrows which members are visible", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "No — only the **first** base (`Student`) shares `&t`; a pointer to a **later** base is adjusted to that subobject's offset", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "`s.id` is 5 (the subclass's own); `s.Person::id` is 0 — both slots physically exist", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "`using` keeps **one** shared member (the base's); redefining creates a **second, independent** slot", correct: true },
