...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "Both the forms and the DB connection",
      correct: true
    }, {
    ...
    choices: [{
      text: "Routes messages: boundary → entities → results",
      correct: true
    }, {
    ...
    choices: [{
      text: "Responsibilities and Collaborators",
      correct: true
    }, {
    ...
    choices: [{
      text: "`Mathematician` created in call; method-local",
      correct: true
    }, {
