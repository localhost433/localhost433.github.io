...
export default mcq({
  questions: [{
    ...
    choices: [{
      text: "The forms **and** the DB connection — every edge the system touches",
      correct: true
    }, {
      text: "Only the forms — the DB connection is an entity object"
    }, {
      text: "Only the DB connection — forms are control objects"
    }, {
      text: "Neither — boundary means the system box itself"
    }],
    ...
    choices: [{
      text: "Orchestrates: receives from the boundary, coordinates the entity objects, routes results back",
      correct: true
    }, {
      text: "Holds the domain data the system remembers"
    }, {
      text: "Renders the output the user sees"
    }, {
      text: "Persists itself into the database"
    }],
    ...
    choices: [{
      text: "has → aggregation, is a kind of → inheritance, borrows → operation",
      correct: true
    }, {
      text: "has → inheritance, is a kind of → aggregation, borrows → attribute"
    }, {
      text: "has → operation, is a kind of → constraint, borrows → association only"
    }, {
      text: "All three verbs → operations"
    }],
    ...
    choices: [{
      text: "Responsibilities and Collaborators, under the class name",
      correct: true
    }, {
      text: "Attributes and Operations, under the class name"
    }, {
    ...
    choices: [{
      text: "`new()` happens inside the handler call — the Mathematician is method-local, not a field",
      correct: true
    }, {
      text: "The return message `result` is dashed, so the class edge must be dashed too"
    }, {
      text: "Mathematician has no attributes"
    }, {
      text: "Nothing — dashed vs solid is a stylistic choice"
    }],
