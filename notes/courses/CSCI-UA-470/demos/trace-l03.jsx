...
const out = (r, col) => ({ expr: "c1 " + (r === 5 ? "-" : r === 50 ? "*" : "/") + " c2",
  result: "c3: radius = " + r + ", color = " + col });

const steps = [
  { line: 1, cells: [c("c1", "No color", 0, true)],
    caption: {
  ...
  { line: 2, cells: [c("c1", "No color", 0), c("c2", "No color", 0, true)],
    caption: {
  ...
  { line: [5, 6], cells: [c("c1", "red", 10), c("c2", "blue", 5, true)],
    caption: {
  ...
  { line: 7, cells: [c("c1", "red", 10), c("c2", "blue", 5), c("c3", "No color", 0, true)],
    caption: {
  ...
  { line: 9, cells: [c("c1", "red", 10), c("c2", "blue", 5), c("c3", "No color", 5, true)],
  ...
  { line: 10, cells: [c("c1", "red", 10), c("c2", "blue", 5), c("c3", "No color", 50, true)],
  ...
  { line: 11, cells: [c("c1", "red", 10), c("c2", "blue", 5), c("c3", "white", 2, true)],
  ...
  { line: 12, cells: [c("c1", "blue", 5, true), c("c2", "blue", 5), c("c3", "white", 2)],
    outputs: [out(5, "No color"), out(50, "No color"), out(2, "white")],
    caption: {
...
const asmMap = {
  1:  [3, 4],          // circle c1;         -> lea [c1] + call circle::circle
  2:  [5, 6],          // circle c2;         -> lea [c2] + call circle::circle
  4:  [8, 9],          // c1.set_color(...)  -> lea [c1] + call circle::set_color
  6:  [10, 11],        // c2.set_color(...)  -> lea [c2] + call circle::set_color
  7:  [12, 13],        // circle c3;         -> lea [c3] + call circle::circle
  9:  [14, 15, 16, 17], // c3 = c1 - c2     -> hidden slot + this + arg + call operator-
  10: [19],            // c3 = c1 * c2       -> call circle::operator*
  11: [21],            // c3 = c1 / c2       -> call circle::operator/
  12: [22, 23, 24],   // c1 = c2            -> lea [c1] + lea [c2] + call operator=
};

const asmLabel = "x86-64 · Intel (idealized)";

export default scene({ title: "L03 — operator overloading on circle objects", code, steps, asm, asmMap, asmLabel });
