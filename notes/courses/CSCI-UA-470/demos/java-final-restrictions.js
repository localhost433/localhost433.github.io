...
const scenarios = [{
  ...
  subtitle: "freeze a binding",
  sub: 0
}, {
  key: "method",
  title: "final method",
  subtitle: "freeze overriding",
  sub: 2
}, {
  key: "class",
  title: "final class",
  subtitle: "freeze subclassing",
  sub: 3
}];
const capRows = [["java", "JAVA", "java"], ["intuition", "INTUITION", "int"]];
const PW = 244,
  PX0 = 12,
  PSTEP = 256;
...
function Caption({
  ...
  }, capRows.map(([key, label, mod]) => /*#__PURE__*/React.createElement("p", {
...
function outcomeRow(x, y, good, code, note) {
  ...
  }), pill(x + 10, y + 12, good ? "OK" : "ERROR", good), /*#__PURE__*/React.createElement("text", {
    x: x + 78,
    y: y + 17,
    textAnchor: "start",
    dominantBaseline: "central",
  ...
  }, code), /*#__PURE__*/React.createElement("text", {
    x: x + 78,
    y: y + 33,
    textAnchor: "start",
    dominantBaseline: "central",
...
function miniClass(x, y, w, name, rows, seg = "stack", dashed = false) {
  ...
  }), rows.map((r, i) => /*#__PURE__*/React.createElement("text", {
    key: i,
    x: x + 9,
    y: y + 44 + i * 17,
    textAnchor: "start",
...
function VariableBody({
  ...
  return /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("text", {
  ...
  }, "frozen: binding"), /*#__PURE__*/React.createElement("rect", {
    x: x + 22,
    y: 142,
    width: 74,
    height: 48,
    ...
    style: {
      ...
      stroke: selected ? "var(--mm-ptr)" : "var(--seg-stack-bd)",
  ...
  }, "final ref"), /*#__PURE__*/React.createElement("line", {
    x1: x + 96,
    y1: 166,
    x2: x + 138,
    y2: 166,
    ...
    style: {
      stroke: selected ? "var(--mm-ptr)" : "var(--mm-muted)",
    ...
    rx: 10,
    style: {
      fill: "var(--seg-heap-bg)",
      stroke: "var(--seg-heap-bd)",
      strokeWidth: 1.2
    }
  }), /*#__PURE__*/React.createElement("text", {
    x: x + 186,
  ...
  }, "Circle"), /*#__PURE__*/React.createElement("line", {
    x1: x + 156,
    y1: 166,
    x2: x + 216,
    y2: 166,
  ...
  }, "radius = 10"), outcomeRow(x + 14, 222, true, "c.radius = 10", "object state may mutate"), outcomeRow(x + 14, 278, false, "c = new Circle()", "binding cannot change"));
}
function MethodBody({
  step,
  x
  ...
  }, "frozen: override"), miniClass(x + 24, 138, 88, "Shape", [{
    text: "final id()",
    bold: true
  }], "global"), /*#__PURE__*/React.createElement("line", {
    x1: x + 114,
    y1: 169,
    x2: x + 140,
    y2: 169,
  ...
  }), miniClass(x + 146, 138, 84, "Circle", [{
    text: "inherits"
  }], "heap"), outcomeRow(x + 14, 222, true, "new Circle().id()", "inherited method is usable"), outcomeRow(x + 14, 278, false, "void id() { }", "same signature override"));
}
function ClassBody({
  step,
  x
  ...
  return /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("text", {
  ...
  }, "frozen: subclassing"), miniClass(x + 67, 138, 110, "Utility", [{
    text: "final class",
    bold: true
  }], "code"), /*#__PURE__*/React.createElement("rect", {
    x: x + 62,
    y: 134,
    width: 120,
    height: 72,
    ...
    style: {
      fill: "none",
      stroke: selected ? "var(--mm-ptr)" : "transparent",
      strokeWidth: 2
    }
  }), outcomeRow(x + 14, 222, true, "new Utility()", "normal use is allowed"), outcomeRow(x + 14, 278, false, "extends Utility", "no subclass may exist"));
}
function scenarioPanel(step, s, x) {
  ...
  return /*#__PURE__*/React.createElement("g", {
    ...
    style: {
      ...
      stroke: activeStroke(step, s.key),
  ...
  }, s.title), /*#__PURE__*/React.createElement("text", {
    x: x + PW / 2,
    y: 85,
    textAnchor: "middle",
    dominantBaseline: "central",
  ...
  }, s.subtitle), s.key === "variable" ? /*#__PURE__*/React.createElement(VariableBody, {
    step: step,
    x: x
  }) : s.key === "method" ? /*#__PURE__*/React.createElement(MethodBody, {
    step: step,
    x: x
  }) : /*#__PURE__*/React.createElement(ClassBody, {
    step: step,
    x: x
  }));
}
function FinalDiagram({
  ...
  }, "same keyword, three different forbidden operations"), scenarios.map((s, i) => scenarioPanel(step, s, PX0 + i * PSTEP)), /*#__PURE__*/React.createElement("line", {
    x1: "12",
    y1: "362",
    x2: "768",
    y2: "362",
...
export default function JavaFinalRestrictions() {
  ...
  }, "Java final - three restrictions, three separate meanings"), /*#__PURE__*/React.createElement(FinalDiagram, {
    step: step
  ...
  }, i + 1, " / ", steps.length)), /*#__PURE__*/React.createElement(CompareCaption, {
    cols: [{
      tag: "variable",
      kind: "java",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "A final variable or field cannot be assigned again after initialization.")
    }, {
      tag: "method",
      kind: "cpp",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "A final method is inherited, but subclasses cannot override that same method signature.")
    }, {
      tag: "class",
      kind: "asm",
      children: /*#__PURE__*/React.createElement(React.Fragment, null, "A final class can be instantiated and used normally, but no class can extend it.")
    }],
