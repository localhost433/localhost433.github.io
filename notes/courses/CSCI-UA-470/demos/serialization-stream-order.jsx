...
const XOBJ = (hl) => heap("Integer object", "Integer", "10", { id: "xobj", hl });
const COBJ = (hl) => heap("Circle object", "Circle", "radius=...", { id: "cobj", hl });
const R1 = (hl) => glob("file[0]", "serialized Integer", "Integer(10)", { id: "r1", hl });
const R2 = (hl) => glob("file[1]", "serialized Circle", "Circle", { id: "r2", hl });
const IOBJ = (hl) => heap("new Integer", "Integer", "10", { id: "iobj", hl });
const CIROBJ = (hl) => heap("new Circle", "Circle", "radius=...", { id: "cirobj", hl });
const I = (hl) => stack("i", "Integer ref", "<- file[0]", { id: "i", to: "iobj", hl });
const CIR = (hl) => stack("cir", "Circle ref", "<- file[1]", { id: "cir", to: "cirobj", hl });
const BAD = (hl) => stack("wrong", "Circle cast", "ClassCastException", { id: "bad", hl });
