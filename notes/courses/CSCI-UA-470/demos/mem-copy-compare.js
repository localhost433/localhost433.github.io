/* AUTO-GENERATED from mem-copy-compare.jsx by `npm run build:artifacts` — do not edit. */
...
const RB = rec => heap("", "int", "0", {
  id: "rb",
  reclaimed: rec
});

/* ---------- LEFT: shallow (default) copy ---------- */
const shallowCode = `class Circle {
    string color;
    int*   radius;
public:
    Circle() {
...
const shallowAsm = `Circle::Circle:
… prologue elided
  call operator new
… epilogue elided
b = a:
