  ...
  questions: [
    {
      ...
      choices: [
        { text: "The forms **and** the DB connection — every edge the system touches", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Orchestrates: receives from the boundary, coordinates the entity objects, routes results back", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Responsibilities and Collaborators, under the class name", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "`new()` happens inside the handler call — the Mathematician is method-local, not a field", correct: true },
