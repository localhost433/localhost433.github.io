  ...
  questions: [
    {
      ...
      choices: [
        { text: "C++ only — `new` allocates any type; Java objects only", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "`class` private; `struct` public by default", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "Deleting via base pointer — else `~Derived` skipped", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "C++ alias (fixed, non-null); Java handle (mutable, nullable)", correct: true },
    ...
    },
    {
      ...
      choices: [
        { text: "C++ `friend` (Java lacks); Java arrays have length", correct: true },
