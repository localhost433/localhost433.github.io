...
const PHASES = [P("Requirements", "the ask", "in the customer's words", 0), P("Analysis", "use cases", "who wants what, and why", 0, "turn wishes into behaviour"), P("Design", "the UML model", "classes · sequences · patterns", 1, "decide how it is built", true), P("Implementation", "the code", "C++ / Java", 1, "translate the model"), P("Testing", "defects", "measured against the use cases", 2, "does it do the ask?"), P("Deployment", "a running system", "in the user's hands", 2, "ship it"), P("Maintenance", "changes", "the ask has moved again", 3, "and round to the top")];
const feed = (steps, feeds) => steps.map((s, i) => ({
  ...s,
  feed: feeds[i]
}));
...
export default function SdlcRolesAi() {
  ...
  }, "The development process, three ways"), /*#__PURE__*/React.createElement(KnobBar, {
    knobs: KNOBS,
    value: {
      view
    },
