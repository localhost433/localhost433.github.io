...
The next step past an abstract class -- where *every* method is abstract -- is an **interface**. For its definition and a side-by-side concrete/abstract/interface comparison, see [OOP: The Four Pillars](note.html?course=CSCI-UA-470&note=14-oop-pillars-roadmap#concrete-vs-abstract-vs-interface).
