...
> Where this sits in the course: the design capstone. Notes [05](note.html?course=CSCI-UA-470&note=05-inheritance)–[09](note.html?course=CSCI-UA-470&note=09-polymorphism-design-java) built the machinery (inheritance, dispatch, abstract classes, interfaces), notes [12](note.html?course=CSCI-UA-470&note=12-uml-use-case-diagrams)–[15](note.html?course=CSCI-UA-470&note=15-uml-to-code) built the notation for wielding it, and SOLID is the judgment layer that says which of the expressible designs will survive their next requirement. For final review, the language rules are consolidated in [note 17](note.html?course=CSCI-UA-470&note=17-java-cpp-systematic-comparison) and the pillar map in [note 18](note.html?course=CSCI-UA-470&note=18-oop-pillars-roadmap).
